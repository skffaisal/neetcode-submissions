    ...
    def decode(self, s: str) -> List[str]:
        ...
        while i< len(s):
            ...
            if (s[i]=="|"):
                ...
                i=j # again setting both variables ready to search for next string 
                continue # ie dont go outside of if and increment 1 again for i, if that happens , someelemets migt get skipped 
            i=i+1
        print(result)
        return result
